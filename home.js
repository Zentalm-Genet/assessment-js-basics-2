...
// Solution 1 By Using The includes() method

// Function to check if the zip code is eligible for delivery
...
console.log(canWeDeliver(85205)); // Output: You are eligible for delivery.
...
console.log(canWeDeliverTwo(85209)) // Sorry, we can't deliver to that address.
console.log(canWeDeliverTwo(85203)) // You are eligible for delivery.

// Solution 3 By Using The find() method 

function canWeDeliverThree(zipCode) {

    // Check if the zip code is in the array of delivery zones
    const isInDeliveryZone = deliveryAreaZipCodes.find(zone => zone === zipCode);

    // Return the appropriate message
    return isInDeliveryZone ? "You're in our delivery zone!" : "Sorry, we can't deliver to that address";
}

// Test cases
console.log(canWeDeliverThree(84606)); // Output: "Sorry, we can't deliver to that address"
console.log(canWeDeliverThree(85205)); // Output: "You're in our delivery zone!"
...
// Reassigning the value of the first deal's title
