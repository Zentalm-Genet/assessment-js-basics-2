...
empOne.getSchedule() // jess works on weekday mornings
...
const empTwo = {...empOne} // Creating a shallow copy of empOne to empTwo
empTwo.name = "Nick"; // Changing the name of empTwo to 'Nick'

console.log(empTwo); // Output: { name: 'Nick', shifts: 'weekday mornings'}
